...
var _Task = require('./components/Task.vue');
...
var check_token = localStorage.getItem("_token");
...
},{"./components/Layout.vue":8,"./components/Login.vue":9,"./components/Task.vue":10,"vue":5,"vue-resource":3,"vue-router":4}],8:[function(require,module,exports){
...
module.exports={
    ...
    methods:
    {
    	authenticate()
    	{
    		this.$http.post('http://socialtasking.dev/api/v1/login',this.loginData).then(function({data}){
    			// $token = JSON.stringify(data);
    			let token = data.token;
    			localStorage.setItem("_token", token);
    			let storedToken = localStorage.getItem("_token");
    			if(storedToken)
    			{
    				this.$set('Authenticated',true);
    				location.assign("http://socialtasking.dev");	
    			}
    			else
    			{
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div>\n  <div class=\"section\"></div>\n  <main>\n    <center>\n      <div class=\"section\"></div>\n\n      <h5 class=\"indigo-text\">Please, login into your account</h5>\n      <div class=\"section\"></div>\n\n      <div class=\"container\">\n        <div class=\"z-depth-1 grey lighten-4 row\" style=\"display: inline-block; padding: 32px 48px 0px 48px; border: 1px solid #EEE;\">\n\n          <form class=\"col s12\" method=\"post\" action=\"/api/v1/login\">\n            <div class=\"row\">\n              <div class=\"col s12\">\n              </div>\n            </div>\n\n            <div class=\"row\">\n              <div class=\"input-field col s12\">\n                <input class=\"validate\" type=\"email\" name=\"email\" id=\"email\" v-model=\"loginData.email\">\n                <label for=\"email\">Enter your email</label>\n              </div>\n            </div>\n\n            <div class=\"row\">\n              <div class=\"input-field col s12\">\n                <input class=\"validate\" type=\"password\" name=\"password\" id=\"password\" v-model=\"loginData.password\">\n                <label for=\"password\">Enter your password</label>\n              </div>\n              <label style=\"float: right;\">\n\t\t\t\t\t\t\t\t<a class=\"pink-text\" href=\"#!\"><b>Forgot Password?</b></a>\n\t\t\t\t\t\t\t</label>\n            </div>\n\n            <br>\n            <center>\n              <div class=\"row\">\n                <button @click.prevent=\"authenticate()\" type=\"submit\" name=\"btn_login\" class=\"col s12 btn btn-large waves-effect indigo\">Login</button>\n              </div>\n            </center>\n          </form>\n        </div>\n      </div>\n      <a href=\"#!\">Create account</a>\n    </center>\n\n    <div class=\"section\"></div>\n    <div class=\"section\"></div>\n  </main>\n </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-5320050a", module.exports)
  } else {
    hotAPI.update("_v-5320050a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-e2c5033a", module.exports)
  } else {
    hotAPI.update("_v-e2c5033a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
